// src/app/api/job-analyzer/evaluate-answer/route.ts — POST: coach feedback on a draft interview answer
...
import { EvaluateInterviewAnswerUseCase } from "@/application/intelligence/commands/EvaluateInterviewAnswer";
import { evaluateAnswerSchema } from "@/lib/validators/interviewCoach.schema";
...
export async function POST(req: NextRequest) {
  ...
  const useCase = new EvaluateInterviewAnswerUseCase(
